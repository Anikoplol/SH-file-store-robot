...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/Straw_Hat_Support)",
                                     disable_web_page_preview=True)
            return
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://telegra.ph/file/a5ede3006fad68b832a90.mp4")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://Straw_Hat_Support).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact me (https://t.me/straw_hat_support).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/straw_hat_support"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/Straw_Hat_Bots")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs")
